 ...
 */
public class XParticleBuilder implements Cloneable {
    ...
    public XParticleBuilder(@NotNull Particle particle) {
     ...
     */
    @NotNull
    public XParticleBuilder particle(@NotNull Particle particle) {
        this.particle = particle;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder allPlayers() {
        this.receivers = null;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder receivers(@Nullable List<Player> receivers) {
     ...
     */
    @NotNull
    public XParticleBuilder receivers(@Nullable Collection<Player> receivers) {
        this.receivers = receivers != null ? Lists.newArrayList(receivers) : null;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder receivers(@Nullable Player... receivers) {
        this.receivers = receivers != null ? Lists.newArrayList(receivers) : null;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder receivers(int radius) {
     ...
     */
    @NotNull
    public XParticleBuilder receivers(int radius, boolean byDistance) {
        if (!byDistance) {
     ...
     */
    @NotNull
    public XParticleBuilder receivers(int xzRadius, int yRadius) {
     ...
     */
    @NotNull
    public XParticleBuilder receivers(int xzRadius, int yRadius, boolean byDistance) {
        if (!byDistance) {
            return receivers(xzRadius, yRadius, xzRadius);
        } else {
            this.receivers = Lists.newArrayList();
     ...
     */
    @NotNull
    public XParticleBuilder receivers(int xRadius, int yRadius, int zRadius) {
        if (location == null) {
     ...
     */
    @NotNull
    public XParticleBuilder source(@Nullable Player source) {
        this.source = source;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder location(@NotNull Location location) {
     ...
     */
    @NotNull
    public XParticleBuilder location(@NotNull World world, double x, double y, double z) {
     ...
     */
    @NotNull
    public XParticleBuilder count(int count) {
        this.count = count;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder offset(double offsetX, double offsetY, double offsetZ) {
     ...
     */
    @NotNull
    public XParticleBuilder extra(double extra) {
        this.extra = extra;
        return this;
    }
     ...
     */
    @NotNull
    public <T> XParticleBuilder data(@Nullable T data) {
        this.data = data;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder force(boolean force) {
        this.force = force;
        return this;
    }
     ...
     */
    @NotNull
    public XParticleBuilder color(@Nullable Color color) {
     ...
     */
    @NotNull
    public XParticleBuilder color(@Nullable Color color, float size) {
     ...
     */
    @NotNull
    public XParticleBuilder color(int r, int g, int b) {
     ...
     */
    @NotNull
    public XParticleBuilder color(final int rgb) {
     ...
     */
    @NotNull
    public XParticleBuilder colorTransition(@NotNull final Color fromColor, @NotNull final Color toColor) {
     ...
     */
    @NotNull
    public XParticleBuilder colorTransition(final int fromRed, final int fromGreen, final int fromBlue,
     ...
     */
    @NotNull
    public XParticleBuilder colorTransition(final int fromRgb, final int toRgb) {
     ...
     */
    @NotNull
    public XParticleBuilder colorTransition(@NotNull final Color fromColor,
    ...
    @NotNull
    @Override
    public XParticleBuilder clone() {
        try {
            final XParticleBuilder builder = (XParticleBuilder) super.clone();
